...
`src/main/java/hello/Server.java`
[source,java]
----
include::complete/src/main/java/hello/Server.java[]
----
...
* https://spring.io/guides/gs/securing-web/[Securing a Web Server]
...
* https://spring.io/guides/gs/spring-boot/[Building an Server with Spring Boot]
